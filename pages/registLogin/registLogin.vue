<template>
	<view class="body">
		<form @submit="formSubmit" @reset="formReset">
			<view class="face-wapper"><image src="../../static/icond2.png" class="face"></image></view>
			...
			<button type="primary" form-type="submit" style="margin-top: 60upx; width: 90%;">登录/注册</button>
		</form>
		...
		<view class="third-wapper">
			...
			<view class="third-icos-wapper">
				...
				<!-- #ifdef APP-PLUS -->
				<image src="../../static/icona1.png" data-logintype="weixin" @click="appOAuthLogin" class="third-ico"></image>
				<image src="../../static/iconb1.png" data-logintype="qq" @click="appOAuthLogin" class="third-ico" style="margin-left: 80upx;"></image>
				<image src="../../static/iconc1.png" data-logintype="sinaweibo" @click="appOAuthLogin" class="third-ico" style="margin-left: 80upx;"></image>
				<!-- #endif -->
				<!-- #ifdef MP-WEIXIN -->
